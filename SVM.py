...
Support_Vector_Machine = SVC(C=10, gamma=0.2, random_state = 0)

Support_Vector_Machine.fit(Training_Data, Training_Labels)

Prediction_Labels = Support_Vector_Machine.predict(Testing_Data)

Confusion_Matrix = confusion_matrix(Testing_Labels, Prediction_Labels)

print("\nTraining Accuracy Score Obtained is: {0:.2f}%".format(accuracy_score(Training_Labels, Support_Vector_Machine.predict(Training_Data))*100.))
...
joblib.dump(Support_Vector_Machine, 'SVM.pkl')